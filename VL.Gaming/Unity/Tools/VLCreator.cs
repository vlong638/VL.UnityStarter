...
namespace VL.Gaming.Unity.Tools
{
    ...
    public static class VLCreator
    {
        ...
        {
            Sprite spriteBackground = VLResourcePool.Sprite_Background;
            Sprite spriteUIMask = VLResourcePool.Sprite_UIMask;
            Sprite spriteUISprite = VLResourcePool.Sprite_UISprite;
        ...
        public static GameObject CreateSprite(string name = "Sprite", Sprite sprite = null, GameObject parent = null)
        {
            GameObject gameObject = new GameObject(name);
            if (parent) gameObject.transform.SetParent(parent.transform);
