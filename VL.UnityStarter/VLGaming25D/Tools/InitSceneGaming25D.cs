...
namespace VL.UnityStarter.VLGaming25D
{
    public static class InitSceneGaming25D
    {

        [MenuItem("Tools/InitSceneGaming2D")]
        static void Init()
        {
            ...
            //var ground1 = VLCreater25D.CreateGround("ground1",entitiesGO);
